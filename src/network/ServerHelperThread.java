					...
					else if (str.charAt(0) == 'O')
					{
						...
						synchronized (st) {
							if (opponentThread.readyToPlay) {
								...
								GameThread gt = new GameThread(tokens[5], tokens[0], tokens[1], tokens[2], tokens[3], Integer.valueOf(tokens[7]), Integer.valueOf(tokens[7]), Integer.valueOf(tokens[6]), tokens[4], false);
